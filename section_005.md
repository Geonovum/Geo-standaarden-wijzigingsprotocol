...
<br/>
<b>Website(s)</b>
De actuele vigerende versies van de basisset geo-standaarden zijn beschikbaar via de publicatieservers (zie <span style='background-color: yellow;'>paragraaf 2.2</span>) en te vinden en raadpleegbaar via de Geonovum website. 
<br/>
<br/>
<b>Consultatie</b>
Bij X-wijzigingen zal Geonovum de aanpassingen in het model in een publieke consultatie aan eenieder voorleggen (zie <span style='background-color: yellow;'>paragraaf 2.2.2</span>).
<br/>
<br/>
<b>Werkafspraken</b>
De werkafspraken bepalen hoe er in de tussentijd moet worden omgegaan met geconstateerde fouten en problemen (zie <span style='background-color: yellow;'>Hoofdstuk 4</span>). De werkafspraken publiceren wij via de Geonovum website. Door middel van nieuwsberichten op de website en het versturen van de nieuwsbrief De Geo-standaard informeren wij het werkveld over de nieuwe dan wel aangepaste werkafspraak.
<br/>
<br/>
